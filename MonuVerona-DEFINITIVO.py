...
def on_callback_query(msg):
  ...
  if query_data == 'bussolengo':
    ...
    bot.sendLocation(chat_id, latitude=45.471315, longitude=10.85553)
...
posizioni_bussolengo = [
    {"latitude": 45.471315, "longitude": 10.85553},
    {"latitude": 45.5250, "longitude": -122.6825},
    {"latitude": 45.5219, "longitude": -122.6786}]

def start(update, context):
        for posizione in posizioni_bussolengo:
            latitude = posizione["latitude"]
            longitude = posizione["longitude"]
            bot.sendLocation(chat_id=update.effective_chat.id, latitude=latitude, longitude=longitude)
